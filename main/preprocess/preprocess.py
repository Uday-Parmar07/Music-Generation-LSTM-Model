...
KERN_DATASET_PATH = r"main\PreProcess\deutschl\erk"
SAVE_DIR = r"E:\Projects\Music-Generation-LSTM-Model\main\dataset"
SINGLE_DATASET = r"E:\Projects\Music-Generation-LSTM-Model\main\single_dataset"
MAPPING_PATH = r"E:\Projects\Music-Generation-LSTM-Model\main\mapping.json"
SEQUENCE_LENGTH = 64
...
def songs_to_int(songs):
    ...
    songs = songs.split() # split at empty space

    for symbol in songs:
        song_int.append(mappings[symbol])
...
def generate_training_sequences(sequence_length):
    ...
    for i in range(0,num_sequences,1000):
